...
component_rows <- bind_rows(
  ...
  missing_summary(dat, "HR", "hr_bnp_type", "Heart BNP type", "Heart US-CRS proxy component", "Categorical BNP vs NT-proBNP indicator", "RiskStratDataHR type used when available; statjust-only BNP values coded unknown and assigned the BNP coefficient", "Heart person waitlist episodes", "Organ-score components"),
