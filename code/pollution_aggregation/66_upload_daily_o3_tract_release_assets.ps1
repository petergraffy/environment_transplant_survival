param(
  ...
  [string]$Target = "main",
  [string]$AssetDir = "data/release/o3_tract_daily_cook_county_il_csv",
...
$headers = @{
  ...
  "User-Agent" = "environment-transplant-survival-o3-tract-upload"
}
...
try {
  ...
  $body = @{
    ...
    name = "Cook County tract environmental daily exposure assets v1"
    body = "Daily tract environmental exposure assets for Cook County, Illinois."
    draft = $false
    prerelease = $false
  }
